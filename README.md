...
The app is now running at `http://localhost:5173`. Open it on your phone (same Wi-Fi) or in your desktop browser and try punching in on a job.
...
No environment variables or secrets are required — the app has no backend.
