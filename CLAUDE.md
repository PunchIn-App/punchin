...
Screenshots live in `docs/screenshots/{phone,tablet,desktop}/` and are embedded in `README.md`. They are committed to the repo but must be **generated by the Playwright script** — never captured and saved by hand.
