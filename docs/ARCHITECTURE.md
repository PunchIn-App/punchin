...
│   │   ├── TimesheetsView.jsx  # Daily/weekly time logs + search + CSV/print/invoice export. Daily = compact entry rows (job-colour dot · name + labor tag + time · duration + edit/delete); Weekly = a unified day-totals list (each day collapsed to its total, tap-to-expand reveals its entries) beside a hero week-total + by-job rail
